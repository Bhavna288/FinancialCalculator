...
//import com.example.navigation.ViewSIPPlanner
import kotlinx.android.synthetic.main.cardlayout_sip_view.view.*
import kotlinx.android.synthetic.main.sip_header.view.*


class SipPlannerViewAdapter (private val mContext: Context, private val viewsipplanitems: ArrayList<ViewSIPPlanitems>) :
